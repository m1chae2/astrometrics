"""Purpose: Unit tests for resolve_filter_wfwhm_with_floor's loosening.

Description: Verifies the loosening ladder that keeps a sharpness
filter from leaving too few frames to stack.
"""
