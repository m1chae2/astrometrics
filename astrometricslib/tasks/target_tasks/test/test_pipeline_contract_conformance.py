...
from astrometricslib.tasks.pipeline_contract import AnalysisPipeline
from astrometricslib.tasks.target_tasks.pipelines.asteroid_recovery import AsteroidRecoveryPipelineAdapter
from astrometricslib.tasks.target_tasks.pipelines.astrometry import AstrometryPipelineAdapter
from astrometricslib.tasks.target_tasks.pipelines.photometry import PhotometryPipelineAdapter
from astrometricslib.tasks.target_tasks.pipelines.spectroscopy import SpectroscopyPipelineAdapter
